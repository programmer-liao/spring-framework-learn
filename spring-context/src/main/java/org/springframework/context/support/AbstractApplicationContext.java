...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	// refresh函数中包含了几乎AppliationContext中提供的全部功能
	@Override
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// 完成刷新过程，通知生命周期处理器lifecycleProcessor刷新过程，同时发出ContentRefreshEvent通知别人
				finishRefresh();
			}
	 ...
	 * @see #getBeanFactory()
	 */
	// ApplicationContext是对BeanFactory的功能上的扩展，不但包含了BeanFactory的全部功能更在其基础上添加了大量的扩展应用，
	// obtainFreshBeanFactory正是实现BeanFactory的地方，也就是经过了这个函数后ApplicationContext就已经拥有了BeanFactory的全部功能
